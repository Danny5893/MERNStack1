...
let HeaderComponent = (props)=>{
    ...
    let studentName = props.student && props.student.studentName ? props.student.studentName : "No Student Initialized";
    return(
        <>
             Hi <b>{studentName +", "}</b> Welcome to SynergisticIT Shopping Cart 
            ...
            <div>
                ...
                <NavLink to="/student" className="button" activeclassname="success" >Student Login </NavLink>
